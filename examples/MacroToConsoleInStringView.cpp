...
int main()
{
	...
	log_ver(__LINE__, " mattis dolor id,  : "sv, " vestibulum nibh.", "Nulla in auctor leo. "sv);
	log_debug(__LINE__, "Nunc a varius purus. : "sv, 3.14159, "Proin dictum erat sit amet posuere tristique. ", "Fusce a arcu rhoncus, "sv);
